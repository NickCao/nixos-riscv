            ...
            nixpkgs = {
              ...
              overlays = [
                (self: super: {
                  ...
                  bootrom-unmatched = super.runCommand "bootrom"
                    {
                    ...
                    sgdisk -g --clear -a 1 \
                      ...
                      "$out/flash.bin"
                    dd if=${self.uboot-unmatched}/u-boot-spl.bin of="$out/flash.bin" bs=4096 seek=5 conv=sync
                    dd if=${self.uboot-unmatched}/u-boot.itb  of="$out/flash.bin" bs=4096 seek=261 conv=sync
